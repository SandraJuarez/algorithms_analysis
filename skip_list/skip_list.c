...
void insert(SkipList* skipList, int key, int maxLevels) {
    ...
    int newLevel = randomLevel(maxLevels);
...
int main() {
    ...
    insert(skipList, 3, maxLevels);
    insert(skipList, 6, maxLevels);
    insert(skipList, 7, maxLevels);
    insert(skipList, 9, maxLevels);
    insert(skipList, 12, maxLevels);
    ...
    int keyToSearch = 7;
    Node* result = search(skipList, keyToSearch);
